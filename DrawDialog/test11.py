...
import os
os.chdir('/Users/robin/workspace/graduation_project/DATA/part1/HashTopologyHandle')
filename='result.txt'
G1=nx.Graph()
G2=nx.Graph()
G3=nx.Graph()
...
with open(filename) as file:
    for line in file:
        ...
        if head=="19_10":
            G4.add_edge(head,tail,weight=w)
        if float(w)>=0.999:
...
nx.draw(G4,pos,node_color='y',with_labels=True,node_size=70,edge_color='g',width=3)
plt.show()
